...
$CONFIG = '{"lang":"zh-CN","error_reporting":false,"show_hidden":false,"hide_Cols":false,"calc_folder":false,"theme":"light"}';
...
if (isset($_GET['upload']) && !FM_READONLY) {
    ...
    <link href="./aobocss/dropzone.min.css" rel="stylesheet">
    <div class="path">
    ...
    <script src="./aobocss/dropzone.min.js"></script>
    <script>
...
<head>
    ...
    <link rel="stylesheet" href="./aobocss/bootstrap.min.css">
    <style>
...
<script src="./aobocss/jquery.slim.min.js"></script>
<script src="./aobocss/bootstrap.min.js"></script>
</body>
</html>
<?php
}
...
<head>
    ...
    <title><?php echo fm_enc(APP_TITLE) ?></title>
    <link rel="stylesheet" href="./aobocss/bootstrap.min.css">
    <link rel="stylesheet" href="./aobocss/font-awesome.min.css">
    <link rel="stylesheet" href="./aobocss/ekko-lightbox.css" />
    <?php if (FM_USE_HIGHLIGHTJS): ?>
    <link rel="stylesheet" href="./aobocss/<?php echo FM_HIGHLIGHTJS_STYLE ?>.min.css">
    <?php endif; ?>
    <style>
...
<script src="./aobocss/jquery.min.js"></script>
<script src="./aobocss/bootstrap.min.js"></script>
<script src="./aobocss/jquery.dataTables.min.js"></script>
<script src="./aobocss/ekko-lightbox.min.js"></script>
<?php if (FM_USE_HIGHLIGHTJS): ?>
    <script src="./aobocss/highlight.min.js"></script>
...
<?php if (isset($_GET['edit']) && isset($_GET['env']) && FM_EDIT_FILE):
        ...
        ?>
    <script src="./aobocss/ace.js"></script>
    <script>
